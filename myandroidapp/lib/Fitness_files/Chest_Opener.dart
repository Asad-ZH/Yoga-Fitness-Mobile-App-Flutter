...
import 'package:myandroidapp/Fitness_files/sub_fitness_file/chest_opener__info.dart';

class  ChestOpener extends StatelessWidget {
            ...
            children:[
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text("Chest Opener", style: TextStyle(color: Colors.white,fontSize: 24)),
                    SizedBox(height: 20,),
                ...
                children: [
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () => Navigator.push(context,
                        MaterialPageRoute(
                            builder: (context) => ChestOpenerInfo()),
                      )
                  ),
