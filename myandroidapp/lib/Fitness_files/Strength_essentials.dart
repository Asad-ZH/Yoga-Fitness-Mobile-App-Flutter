...
class  StrengthEssentials extends StatelessWidget {
            ...
            children:[
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text("Strength Essentials", style: TextStyle(color: Colors.white,fontSize: 24)),
                    SizedBox(height: 20,),
                ...
                children: [
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () => Navigator.push(context,
                        MaterialPageRoute(
                            builder: (context) => StrengthEssentialsInfo()),
                      )
                  ),
